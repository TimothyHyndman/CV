...
tribble(
  ...
  "Data scientist", "Biarri", "Windsor, Australia", "May. 2019 - Present", "I have also developed ranking algorithms for a competitor form of Poker, produced a performance analysis on a 3rd party's electricity forecasting algorithms, and determined factors that correlated with poor sales growth for an outdoor activities retailer.",
...
# Relevant Skills
  ...
  * Familiar with C++
  * Experience using Docker, Docker Compose, and AWS (S3 and Athena)
...
tribble(
  ...
  "icon", "2017", "Author", "Embed SVG icons in R documents such as slides, reports and apps.","https://github.com/ropenscilabs/icon",
  "cricketdata", "2017", "Author", "International cricket data for men adn women, Tests, ODIs, and T20s.","https://github.com/ropenscilabs/cricketdata",
) %>% 
