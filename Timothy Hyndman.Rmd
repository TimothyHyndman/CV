...
tribble(
  ...
  "Programming", "Python, R, MATLAB, SQL, Bash",
  "Tools", "Git, Docker, AWS (S3 and Athena), TeX"
...
tribble(
  ...
  "cricketdata", "2017", "Author", "International cricket data for men and women, Tests, ODIs, and T20s.","https://github.com/ropenscilabs/cricketdata",
) %>% 
